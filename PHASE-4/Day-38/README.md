...
From the project root, run the backend server and serve the frontend together with a single command:
...
The app will serve `index.html` and all static files, plus the backend API, from the same process.
